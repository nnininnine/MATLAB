function varargout = gui_mat5(varargin)
% GUI_MAT5 MATLAB code for gui_mat5.fig
%      GUI_MAT5, by itself, creates a new GUI_MAT5 or raises the existing
%      singleton*.
%
%      H = GUI_MAT5 returns the handle to a new GUI_MAT5 or the handle to
%      the existing singleton*.
%
%      GUI_MAT5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_MAT5.M with the given input arguments.
%
%      GUI_MAT5('Property','Value',...) creates a new GUI_MAT5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_mat5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_mat5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_mat5

% Last Modified by GUIDE v2.5 09-Dec-2019 17:20:12

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_mat5_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_mat5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_mat5 is made visible.
function gui_mat5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_mat5 (see VARARGIN)

% Choose default command line output for gui_mat5
...
% UIWAIT makes gui_mat5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = gui_mat5_OutputFcn(hObject, eventdata, handles) 
...
if handles.rb_normal.Value == 1
        set(handles.edit_import,'enable','off');
        B = [str2double(get(handles.n1,'string')) str2double(get(handles.n6,'string')) str2double(get(handles.n11,'string')) str2double(get(handles.n16,'string')) str2double(get(handles.n21,'string'));
             str2double(get(handles.n2,'string')) str2double(get(handles.n7,'string')) str2double(get(handles.n12,'string')) str2double(get(handles.n17,'string')) str2double(get(handles.n22,'string'));
             str2double(get(handles.n3,'string')) str2double(get(handles.n8,'string')) str2double(get(handles.n13,'string')) str2double(get(handles.n18,'string')) str2double(get(handles.n23,'string'));
             str2double(get(handles.n4,'string')) str2double(get(handles.n9,'string')) str2double(get(handles.n14,'string')) str2double(get(handles.n19,'string')) str2double(get(handles.n24,'string'));
             str2double(get(handles.n5,'string')) str2double(get(handles.n10,'string')) str2double(get(handles.n15,'string')) str2double(get(handles.n20,'string')) str2double(get(handles.n25,'string'));
             ];
        ...
        set(handles.a17, 'string' , sprintf("%0.2f",A(17)));
        set(handles.a18, 'string' , sprintf("%0.2f",A(18)));
        set(handles.a19, 'string' , sprintf("%0.2f",A(19)));
        set(handles.a20, 'string' , sprintf("%0.2f",A(20)));
        set(handles.a21, 'string' , sprintf("%0.2f",A(21)));
        set(handles.a22, 'string' , sprintf("%0.2f",A(22)));
        set(handles.a23, 'string' , sprintf("%0.2f",A(23)));
        set(handles.a24, 'string' , sprintf("%0.2f",A(24)));
        set(handles.a25, 'string' , sprintf("%0.2f",A(25)));
    ...
    elseif handles.rb_random.Value == 1
        ...
        set(handles.n17, 'string' , randomNum(17));
        set(handles.n18, 'string' , randomNum(18));
        set(handles.n19, 'string' , randomNum(19));
        set(handles.n20, 'string' , randomNum(20));
        set(handles.n21, 'string' , randomNum(21));
        set(handles.n22, 'string' , randomNum(22));
        set(handles.n23, 'string' , randomNum(23));
        set(handles.n24, 'string' , randomNum(24));
        set(handles.n25, 'string' , randomNum(25));
        ...
        set(handles.a17, 'string' , sprintf("%0.2f",R(17)));
        set(handles.a18, 'string' , sprintf("%0.2f",R(18)));
        set(handles.a19, 'string' , sprintf("%0.2f",R(19)));
        set(handles.a20, 'string' , sprintf("%0.2f",R(20)));
        set(handles.a21, 'string' , sprintf("%0.2f",R(21)));
        set(handles.a22, 'string' , sprintf("%0.2f",R(22)));
        set(handles.a23, 'string' , sprintf("%0.2f",R(23)));
        set(handles.a24, 'string' , sprintf("%0.2f",R(24)));
        set(handles.a25, 'string' , sprintf("%0.2f",R(25)));
        set(handles.timeloop,'string',sprintf("%0.6f ms",timel));
        set(handles.timespark,'string',sprintf("%0.6f ms",times));
    else
        ...
        set(handles.n17, 'string' , M(17));
        set(handles.n18, 'string' , M(18));
        set(handles.n19, 'string' , M(19));
        set(handles.n20, 'string' , M(20));
        set(handles.n21, 'string' , M(21));
        set(handles.n22, 'string' , M(22));
        set(handles.n23, 'string' , M(23));
        set(handles.n24, 'string' , M(24));
        set(handles.n25, 'string' , M(25));
        ...
        set(handles.a17, 'string' , sprintf("%0.2f",P(17)));
        set(handles.a18, 'string' , sprintf("%0.2f",P(18)));
        set(handles.a19, 'string' , sprintf("%0.2f",P(19)));
        set(handles.a20, 'string' , sprintf("%0.2f",P(20)));
        set(handles.a21, 'string' , sprintf("%0.2f",P(21)));
        set(handles.a22, 'string' , sprintf("%0.2f",P(22)));
        set(handles.a23, 'string' , sprintf("%0.2f",P(23)));
        set(handles.a24, 'string' , sprintf("%0.2f",P(24)));
        set(handles.a25, 'string' , sprintf("%0.2f",P(25)));
        set(handles.timeloop,'string',sprintf("%0.6f ms",timel));
        set(handles.timespark,'string',sprintf("%0.6f ms",times));
    end 
...
% Hints: get(hObject,'String') returns contents of n17 as text
%        str2double(get(hObject,'String')) returns contents of n17 as a double


% --- Executes during object creation, after setting all properties.
function n17_CreateFcn(hObject, eventdata, handles)
% hObject    handle to n17 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hints: get(hObject,'String') returns contents of n18 as text
%        str2double(get(hObject,'String')) returns contents of n18 as a double


% --- Executes during object creation, after setting all properties.
function n18_CreateFcn(hObject, eventdata, handles)
% hObject    handle to n18 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hints: get(hObject,'String') returns contents of n19 as text
%        str2double(get(hObject,'String')) returns contents of n19 as a double


% --- Executes during object creation, after setting all properties.
function n19_CreateFcn(hObject, eventdata, handles)
% hObject    handle to n19 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hints: get(hObject,'String') returns contents of a17 as text
%        str2double(get(hObject,'String')) returns contents of a17 as a double


% --- Executes during object creation, after setting all properties.
function a17_CreateFcn(hObject, eventdata, handles)
% hObject    handle to a17 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hints: get(hObject,'String') returns contents of a18 as text
%        str2double(get(hObject,'String')) returns contents of a18 as a double


% --- Executes during object creation, after setting all properties.
function a18_CreateFcn(hObject, eventdata, handles)
% hObject    handle to a18 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hints: get(hObject,'String') returns contents of a19 as text
%        str2double(get(hObject,'String')) returns contents of a19 as a double


% --- Executes during object creation, after setting all properties.
function a19_CreateFcn(hObject, eventdata, handles)
% hObject    handle to a19 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hints: get(hObject,'String') returns contents of n22 as text
%        str2double(get(hObject,'String')) returns contents of n22 as a double


% --- Executes during object creation, after setting all properties.
function n22_CreateFcn(hObject, eventdata, handles)
% hObject    handle to n22 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hints: get(hObject,'String') returns contents of n23 as text
%        str2double(get(hObject,'String')) returns contents of n23 as a double


% --- Executes during object creation, after setting all properties.
function n23_CreateFcn(hObject, eventdata, handles)
% hObject    handle to n23 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hints: get(hObject,'String') returns contents of n24 as text
%        str2double(get(hObject,'String')) returns contents of n24 as a double


% --- Executes during object creation, after setting all properties.
function n24_CreateFcn(hObject, eventdata, handles)
% hObject    handle to n24 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hints: get(hObject,'String') returns contents of n20 as text
%        str2double(get(hObject,'String')) returns contents of n20 as a double


% --- Executes during object creation, after setting all properties.
function n20_CreateFcn(hObject, eventdata, handles)
% hObject    handle to n20 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hints: get(hObject,'String') returns contents of n25 as text
%        str2double(get(hObject,'String')) returns contents of n25 as a double


% --- Executes during object creation, after setting all properties.
function n25_CreateFcn(hObject, eventdata, handles)
% hObject    handle to n25 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
